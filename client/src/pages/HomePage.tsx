  ...
  return (
    <div className="container mx-auto p-8 py-16">
      <section className="text-center bg-white p-12 md:p-20 rounded-xl shadow-xl max-w-4xl mx-auto">
        <h1 className="font-serif text-4xl md:text-5xl font-bold mb-4 text-gray-800">Encontre Perspectiva na Filosofia</h1>
        <h2 className="font-sans text-2xl text-gray-600 mb-8">Um guia de acolhimento para os desafios do dia a dia.</h2>
        <p className="font-sans text-lg text-gray-500 mb-10 max-w-2xl mx-auto leading-relaxed">
          Você não está sozinho(a) nessa busca. Explore histórias que conectam os desafios do dia a dia com a sabedoria filosófica.
        </p>
        <Button
          asChild
          size="lg"
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Link to="/explorar">
            <Card className="bg-white shadow-lg border-0 text-center transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
              ...
              <CardContent>
                <p className="font-sans text-gray-600 leading-relaxed">Uma reflexão sobre como encontrar paz e equilíbrio em meio ao caos diário.</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link to="/explorar">
            <Card className="bg-white shadow-lg border-0 text-center transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
              ...
              <CardContent>
                <p className="font-sans text-gray-600 leading-relaxed">Uma perspectiva filosófica para abraçar a incerteza e encontrar calma.</p>
              </CardContent>
            </Card>
          </Link>
        </div>
